...
import { Shield, UserPlus, Zap, Mail, Key, User, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-24 bg-bg-base relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand/10 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand/10 rounded-full blur-[120px]"></div>
      </div>
      ...
      >
        <div className="text-center space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-sans font-black tracking-tighter text-text-main uppercase">Operator Onboarding</h1>
            <p className="text-[10px] text-text-muted uppercase font-bold tracking-widest italic leading-relaxed">Join the high-performance network.</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-text-main group-hover:text-brand transition-colors">Register via Google</span>
          </button>

          <div className="relative flex items-center">
            <div className="flex-grow border-t border-border-dim"></div>
            <span className="flex-shrink-0 px-4 text-[9px] font-black uppercase tracking-widest text-text-muted">MANUAL PROTOCOL</span>
            <div className="flex-grow border-t border-border-dim"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center space-x-2 ml-1 text-text-muted">
                  <User size={10} />
                  <label className="text-[10px] uppercase font-black">Operator Codename</label>
                </div>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2 ml-1 text-text-muted">
                  <Mail size={10} />
                  <label className="text-[10px] uppercase font-black">Identity Token</label>
                </div>
                <input
                  type="email"
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2 ml-1 text-text-muted">
                  <Key size={10} />
                  <label className="text-[10px] uppercase font-black">Generate Passkey</label>
                </div>
                <input
                  type="password"
                  placeholder="••••••••"
            ...
            >
              <UserPlus size={14} className="fill-white" />
        ...
        <div className="pt-8 border-t border-border-dim text-center space-y-4">
          <p className="text-[10px] text-text-muted font-bold uppercase tracking-widest leading-relaxed">
            Already Onboarded? <Link to="/login" className="text-brand hover:underline">Return to Authenticator</Link>
          </p>
        </div>
      </motion.div>
    </div>
